...
#set page(
  paper: "a5",
  margin: (x: 1cm, y: 1cm),
  header: align(right, text(8pt, style: "italic")[E. Kirkwood - Chimie MPSI]),
)
...
#let parts = (
  ...
  "Réactions": "Reactions/reactions.typ",
  "Cristallographie": "Cristallo/cristallo.typ",
)
