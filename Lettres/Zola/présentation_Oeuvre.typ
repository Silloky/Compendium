...
#LO, paru en 1886, est le quatorzième volume du cycle des _Rougon-Macquart_, qui en compte vingt. 
...
A noter que #Z donne aussi de lui-même au personnage de Claude : le prénom fait écho au titre du premier roman de l'écrivain, _La Confession de Claude_ (1865) mais surtout au pseudonyme utilisé pour signer les articles dans lesquels il prenait le défense des peintres écartés du Salon.

=== Un roman sur l'art

On l'aura compris, le thème de l'art tient donc particulièrement à cœur à #Z, et il traite dès ses premiers écrits en 1860 ; c'est le cas de _Thérèse Raquin_ (1867), _Une farce_ (1877) et  _Madame Sourdis_ (1880).

Notons que Claude #Lt apparaît déjà dans _Le Ventre de Paris_, le troisième roman des _Rougon-Macquart_ paru en 1873 : il est en admiration devant le spectacle des Halles et rêve d'un #c[art moderne tout expérimental et tout matérialiste], et déjà à l'époque, il ne parvient pas à trouver #c[la note juste] et recommence sans cesse ses esquisses.
...
Bien que, on l'a vu, #LO soit un roman d'art, aucun autre roman de #Z ne fait donc une place aussi grande à la littérature ; y prennent place un romancier, #Sd, un journaliste Jory, #Z lui-même à travers le personnage de #Cl, ou encore Flaubert avec Bongrand.

En affirmant dans #LO les principes d'un art nouveau, #Z ne pense pas seulement à la peinture : en défendant ses amis peintres et leurs volontés de briser les codes, il défend aussi les principes, littéraires cette fois de son propre mouvement : le naturalisme. \
...
Mais une œuvre naturaliste n'est pas non plus une photographie dénuée de tout talent ou effort artistique, il s'agit de sélectionner, tel un expérimentateur en sciences, les éléments pertinents du travail documentaire pour en faire une œuvre d'art. Plus qu'un simple enregistrement passif du réel, l'écriture naturaliste, véritable reconstruction scientifique et artistique, doit viser l'impersonnalité (le refus du lyrisme romantique ou du jugement moral de l'auteur), tout en conservant une puissance esthétique.

Enfin, et bien que cela semble difficilement conciliable avec les points précédents, une œuvre naturaliste doit aussi prendre en compte la personnalité de l'artiste ; c'est dans l'alliance entre la #c[méthode analytique] et le #c[tempérament] que le naturalisme doit trouver son équilibre, d'où la fameuse définition de l'art selon #Z, #c[un coin de la nature vu à travers un tempérament].

Le sous-titre donné aux _Rougon-Macquart_ est _Histoire naturelle et sociale d'une famille sous le Second Empire_. "Histoire", parce que #Z choisit une époque très précise ; "Histoire naturelle" parce qu'il s'agit d'étudier l'influence de la physiologie, des corps, sur les comportements humains ; enfin, "Histoire sociale" parce qu'il s'agit d'exposer précisément et dans tous ses détails les réalités de chaque profession. \ En effet, la naturalisme se caractérise par un projet que #Z formule dès son premier plan des _Rougon-Macquart_ : le romancier doit se dédoubler en un physiologiste et un sociologue.